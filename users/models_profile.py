...
class TherapistProfile(models.Model):
    ...
    # New split: intro_note (short) and personal_statement_01 (longer About Me)
    intro_note = models.TextField(max_length=500, blank=True)
    personal_statement_01 = models.TextField(max_length=1000, blank=True)
    # Legacy field kept temporarily for migration/backwards compatibility
    ...
    accepting_new_clients = models.CharField(max_length=32, default="Yes")
    ...
    # Rich text / longer explanation of cancellation or missed appointment terms
    no_show_policy = models.TextField(max_length=1000, blank=True)
