...
from .views_blog import blog_index, blog_detail, user_blog_list, user_blog_create, user_blog_edit, user_blog_update_visibility, user_blog_delete
...
urlpatterns = [
    ...
    path('my-blogs/<int:pk>/delete/', user_blog_delete, name='user_blog_delete'),
]
